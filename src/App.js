    ...
    <div className="app">
      <div className=''>
        ...
        <form onSubmit={calculateBMI}>
          <div>
            <label className='heightWord'>Height (12 - 96)</label>
            <input value={height} onChange={(event) => setHeight(event.target.value)} />
          </div>
          <br></br>
          <div>
            <label className='weightWord'>Weight (1 - 777)</label>
            <input value={weight} onChange={(e) => setWeight(e.target.value)} />
          </div>

          <div>
         <br></br>
            <button id='submit' className=' btn btn-dark' type='submit'>Submit</button>
            <button className='btn btn-dark' onClick={reload} type='submit'>Reload</button>
          </div>
        </form>
